...
* Uncovered Topics
  ...
  * Approach to a patient with claudication
    
    * PVD
  
  * Approach to a patient with carotid bruit, TIA.
  
    * How to work up
    * When to operate
  
  * Approach to patient with aortic aneurysm
    
    * Symptomatic patient vs asymptomatic
    * Size criteria for operation
    * Open vs endovascular (general)
  
  * Approach to patient with visceral aneurysm
  
    * Spleen in pregnant woman

  * Approach to a patient with a NECK MASS
    
    * Thyroid
    * Parathyroid
    * lymphadenopathy

  * Approach to a patient with a testicular mass
    
    * Cancer
    * hydrocele

  * Approach to a Patient with scrotal pain
    
    * Epididymitis
    * Torsion
  
  * Approach to a patient with flank pain
    
    * Kidney stone

  * Approach to a patient with a skin lesion
    
    * SCC/BSC/Melanoma
  
  * Approach to patient with a soft tissue mass
